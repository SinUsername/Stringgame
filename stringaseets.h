...
void MoveObject (struct positionObject * posPlayer , const char * player , const char * key1 , const char * key2 , const char * key3 , const char * key4){
...
void MoveObjectDX (let X , let Y , String player , String key1 , String key2 , String key3 , String key4){
...
void ShowObjectCoordinates (struct positionObject * CoordinateObject){

    printf("Coordinates: X = %d | Y = %d\n",CoordinateObject->X,CoordinateObject->Y);

}

void ObjectCoordinates (let X , let Y){

    printf("Coordinates: X = %d | Y = %d\n",X,Y);

}

void limitObject (struct positionObject * limitObject , int limitX1 , int limitX2, int limitY1 , int limitY2){

    //Posiciones en X de derecha a izquierda
    if(limitObject->X == limitX1){

        limitObject->X++;

    }

    if(limitObject->X == limitX2){
    ...
    if(limitObject->Y == limitY1){

        limitObject->Y++;

    }

    if(limitObject->Y == limitY2){
